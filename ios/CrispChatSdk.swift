...
@objc(NativeCrispModule)
public class NativeCrispModule: NSObject {
    ...
    @objc
    public func setUserCompany(_ companyData: [String: Any]) {
        let companyDict = companyData as NSDictionary
        let company = CompanyParser.fromDictionary(companyDict)
    ...
    @objc
    public func pushSessionEvent(_ eventName: String, color: Crisp.SessionEventColor) {
